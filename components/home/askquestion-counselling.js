...
export default function AskQuestionCounselling() {
  return (
    <section className="mx-auto sm:mb-6 md:mb-0 p-6 pb-6 py-12 sm:py-12">
      <div className="container sm:mb-6 md:mb-0 max-w-[1260px] pb-6 grid md:grid-cols-2  gap-12">
        <div className="bg-green-50 sm:mb-6 md:mb-0 rounded-lg p-6 shadow-md relative">
