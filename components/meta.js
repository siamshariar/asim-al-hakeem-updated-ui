...
export default function Meta(props) {
  return (
    <Head>
      ...
      <meta property="og:site_name" content="muhammadsaifullah" key="ogsitename" />

      {/* meta information for twitter */}
      <meta name="twitter:card" content="muhammadsaifullah" key="twcard" />
      <meta name="twitter:site" content="@muhammadsaifullah" key="twsite" />
      ...
      <title>
        ...
        {
          "ড. মুহাম্মাদ সাইফুল্লাহ অফিসিয়াল ওয়েবসাইট - Official website of Dr. Muhammad Saifullah"
        }
      </title>
