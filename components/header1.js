...
export default function Header2({
  ...
  // Apply class for fixed header and scroll transitions
  useEffect(() => {
    if (headerRef.current) {
      ...
      // Hide/show header and desktop navigation based on scroll direction
      if (!isScrollingUp) {
  ...
  return (
    <>
      <header ref={headerRef} className="py-4 bg-white lg:pt-6 lg:pb-[40px] transition-all duration-500">
        <div className="lg:hidden flex justify-end mr-10 mt-4">
        ...
        <div className="container mx-auto z-30 lg:relative flex flex-col lg:flex-row justify-between gap-y-4 lg:gap-y-0">
          <div className="flex justify-center mr-[550px] items-center w-full pb-8 lg:w-auto">
            <div className="">
              <Link href="/">
          ...
          <div className="flex flex-col gap-y-4 lg:flex-row lg:gap-x-10 lg:gap-y-0">
            {/* Your existing code for contact info and button */}
            ...
            >
              {/* Your existing desktop nav links */}
