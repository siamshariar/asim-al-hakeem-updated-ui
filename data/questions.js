...
export const faqs = [
  ...
  {
    question: "Can we use scented soaps while in ihram (احرام), or can we use face creams while in ihram for umrah?",
  ...
  },
  {
    ...
    answer:
      "This is totally baseless and an innovation. You can only touch the Yemeni corner and the black stone, whether this is your 1st or last umrah.",
    category: "Hajj and Umrah",
  },
  {
    question:
  ...
  },
  {
    ...
    answer:
      "If he is exempted from fasting according to the instructions of a trusted Muslim doctor and the doctors say that he would never be able to fast again till the rest of his life, he can feed one person after the day of Ramadan is over. You must not give it in advance. But if the doctors say that he will recover in few years time, he must not feed and must wait until he is recovered and then make up all these missed days.",
    category: "Fasting",
  },
  {
    question:
    ...
    answer:
      "A breastfeeding woman can skip fasting without the recommendation of a doctor whether Muslim or kafir if there is hardship or difficulty on her. She must make up for such missed days once she is able.",
    category: "Fasting",
  },
  {
    question: "Sheikh is it permissible to to pray Maghreb and then break my fast",
    answer:
      "No. You must first break your fast, even if only with a date or water and then pray maghrib. Prophet salla Allahu alaihi wa sallam said we must hasten to break the fast.",
    category: "Fasting",
  },
  {
    question:
